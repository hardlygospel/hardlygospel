...
[![GitHub Streak](https://github-readme-streak-stats-eight.vercel.app/?user=hardlygospel&theme=github-dark-blue&hide_border=true)](https://github.com/hardlygospel)
&nbsp;&nbsp;
...
| [🛡️ lockout](https://github.com/hardlygospel/lockout) | macOS / Linux / Windows / Rust | Tony's Ad Blocker: standalone local ad blocker, no browser extension. DNS sinkhole + HTTPS-intercepting filtering proxy + dedicated YouTube & Twitch ad-stripping modules, tray icon and dashboard |
...
| [worldmonitor](https://github.com/hardlygospel/worldmonitor) | TypeScript | AI-powered geopolitical monitoring dashboard |
...
| Repo | Language | Description |
|---|---|---|
| [omarchy](https://github.com/hardlygospel/omarchy) | Shell | Beautiful, modern and opinionated Linux setup |
| [suckless-ubuntu](https://github.com/hardlygospel/suckless-ubuntu) | Shell | Lightweight Ubuntu with suckless.org software |
| [dotfiles](https://github.com/hardlygospel/dotfiles) | Shell | Arch Linux configuration files |
| [aui](https://github.com/hardlygospel/aui) | Shell | Arch Linux ultimate install script |
...
| Repo | Language | Description |
|---|---|---|
| [spotifyplaylist_to_ytmusic](https://github.com/hardlygospel/spotifyplaylist_to_ytmusic) | Python | Clone a Spotify playlist to YouTube Music |
| [AnimaMac](https://github.com/hardlygospel/AnimaMac) | Swift | Native macOS GIF recorder, no time limits |

### 📚 Learning & Books

| Repo | Description |
|---|---|
| [free-programming-books](https://github.com/hardlygospel/free-programming-books) | Freely available programming books |
| [books](https://github.com/hardlygospel/books) | Awesome Books collection |
| [Free-Books](https://github.com/hardlygospel/Free-Books) | Open Books Library mirror |
| [Modern-Python-Cookbook-Second-Edition](https://github.com/hardlygospel/Modern-Python-Cookbook-Second-Edition) | Code from the Packt Python Cookbook |
| [datasciencetoolbox](https://github.com/hardlygospel/datasciencetoolbox) | Complete environments for data scientists |

### 🛠️ Dev Tools & Utilities

| Repo | Language | Description |
|---|---|---|
| [novaflow](https://github.com/hardlygospel/novaflow) | JavaScript | Workflow automation |
| [Reactive-Resume](https://github.com/hardlygospel/Reactive-Resume) | TypeScript | Privacy-focused open-source resume builder |
| [claw-code-parity](https://github.com/hardlygospel/claw-code-parity) | Rust | Parity work for claw-code Rust migration |
| [gatsby-datocms-starter](https://github.com/hardlygospel/gatsby-datocms-starter) | Sass | Sample DatoCMS + Gatsby website starter |
